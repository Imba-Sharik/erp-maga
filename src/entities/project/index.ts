...
export { STAGE_CAPABILITIES, canEditCurrentStage, canAdvanceStage } from './lib/stage-capabilities'
export type { StageCapability } from './lib/stage-capabilities'
export { resolveStageEditAccess } from './lib/resolve-stage-edit-access'
export type { StageEditAccess, ResolveStageEditAccessArgs } from './lib/resolve-stage-edit-access'
export { resolveStageBlockEditable } from './lib/resolve-stage-block-editable'
